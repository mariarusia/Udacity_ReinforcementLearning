...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = 0.999 ** self.iteration_no
            self.iteration_no += 1
        return None
    ...
    def get_maxQ(self, state):
        ...
        maxQ = max(possible_actions_dict.values())
    ...
    def choose_action(self, state):
        ...
        if not self.learning or (random.random() < self.epsilon):
            ...
            # a list of all the actions possible in the state with their values/
            possible_actions_dict = self.Q[state]
            # put actions with best values here
            best_actions = []

            for key, value in possible_actions_dict.items():
                if value == maxQ:
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            self.Q[state][action] = (1 - self.alpha) * value + self.alpha * reward
